###
# This is a wrapper script for the train class of DDE to predict the estimates on a synthetic dataset, as is generated by the function generator.
###
...
parser.add_argument('--dist', default=None, help='synthetic datafile to test on')
