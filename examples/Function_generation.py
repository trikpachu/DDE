import deep_density_estimation.PDF_Generation as g
import time
import argparse
import numpy as np
import glob
...
parser.add_argument('--dim', nargs='+', type=int, default=1, help='dim')
parser.add_argument('--size', nargs='+', type=int, default=1000, help='size')
