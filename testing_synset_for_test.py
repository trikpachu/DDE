###
# This is a wrapper script for the train class of DDE to predict the estimates on a synthetic dataset.
###
...
def main():
    ...
    data_ = pickle.load(open(dist, 'rb'))
    ...
    print(np.shape(estimate[0]))
    print(np.shape(data[0]))

    #import matplotlib.pyplot as plt
    #plt.scatter(data[0][0], ys[0])
    #plt.scatter(data[0][0], estimate[0])
    #plt.show()
